  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 dark:aria-invalid:border-destructive/50 aria-invalid:ring-[3px]',
        'disabled:cursor-not-allowed disabled:border-neutral-400 disabled:bg-neutral-100 disabled:text-neutral-600 disabled:opacity-50',
        '*:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5',
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 data-[state=open]:[&_svg]:rotate-180 [&_svg:not([class*='size-'])]:size-4",
        'h-11 prose-p1',
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ArrowDown className="pointer-events-none size-4 text-neutral-600 transition-transform" />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-muted-foreground px-1.5 py-1 prose-p1', className)}
      {...props}
    />
  )
}
