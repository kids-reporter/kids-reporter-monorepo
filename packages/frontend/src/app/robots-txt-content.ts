...
const ROBOTS_HEADER = `# The Reporter content is made available for your personal, non-commercial
...
const AI_CRAWLER_DISALLOW_RULES = `# Disallow Rules
...
export const devRobotsTxt = `User-agent: *
Disallow: /
`

export const prodRobotsTxt = `${ROBOTS_HEADER}
${AI_CRAWLER_DISALLOW_RULES}
